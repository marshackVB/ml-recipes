...
def create_features():
    ...
    name_extractor = make_pipeline(GetNameFeatures(as_string=True),
                                   GetDummies(drop_first=False))

    categoricals = make_pipeline(GetDummies(drop_first=False))
    ...
    return (features_df, label_col, feature_cols)
...
if __name__ == "__main__":
    ...
    pickle.dump(features_df, open("features_df_one_hot.p", "wb"))
